    ...
    public partial class DatosDePrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 9, 12, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 5, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 9, 10, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 5, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
